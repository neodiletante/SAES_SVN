  ...
  <center>
    ...
    <table id="tabla-alumnos">
        ...
        <tbody>
            ...
            <c:forEach var="referido" items="${referidos}">
               <tr>
                <td class="resultado" id="input_grado">${referido.no_lista}</td>
                <td class="resultado" id="input_grupo">${referido.nombre}</td>
               <td class="centrado">
                    <input class="check_alumno" type="checkbox" name="agrega_alumno" id="agrega-alumno" value="${alumnos.no_exp}"/>
               </td>
               <td>${referido.color}</td>
               <c:forEach var="tipoDato" items="${tiposDato}">
               <jsp:useBean id="sociales" class="java.util.ArrayList" scope="session" />
                <td class="centrado">
